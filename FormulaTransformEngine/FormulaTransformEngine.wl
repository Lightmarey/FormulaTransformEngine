...
ClearAll[
  $FTPackageDirectory, $FTPacletDirectory, $FTRuleRegistry, $FTHeuristicRegistry, $FTEstimateSeedRegistry, $FTStructuralRegistry, $FTDischargerRegistry, $FTTargetPlannerRegistry,
...
$FTPacletDirectory = DirectoryName[$FTPackageDirectory];
